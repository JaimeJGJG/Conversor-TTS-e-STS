...
class Janela (QMainWindow):
    def __init__(self):
        ...
        self.caixa_texto.setStyleSheet('QLineEdit {background-color:black;color:white;border-radius: 5px}')
        ...
        botao_caixa = QPushButton("",self)
        botao_caixa.move(110,110)
        botao_caixa.resize(80,30)
        botao_caixa.setStyleSheet("background-image : url(convert.png);border-radius: 5px")
